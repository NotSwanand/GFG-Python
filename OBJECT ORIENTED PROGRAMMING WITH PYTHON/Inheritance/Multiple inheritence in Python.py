...
class Student:
    ...
    def get_info(self):
        return "StudentID:"+str(self.sid) + " DepartmentID:"+str(self.deptid)
...
class Faculty:
    ...
    def get_info(self):
        return "EmployeeID:"+str(self.eid) + " DepartmentID:"+str(self.deptid)
...
class PhDStudent(Student, Faculty):
    ...
    def get_info(self):
        return "StudentID:"+str(self.sid) + " EmployeeID:"+str(self.eid) + " DepartmentID:"+str(self.deptid)
